    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 465px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Thêm tỉnh mới</span></div>
          <div class="box_form">
          	<div class="list_tab_content">
          		<div class="li_tab_content active" id="tab_hangnhap_content">
          			<div class="li_input">
          				<label>Tên tỉnh(*)</label>
          				<input type="text" name="tieu_de" placeholder="Nhập tên tỉnh" autocomplete="off">
          			</div>
                <div class="li_input">
                  <label>Thứ tự</label>
                  <input type="text" name="thu_tu" placeholder="Nhập thứ tự hiển thị" autocomplete="off">
                </div>
          			<div class="list_button">
          				<button name="add_tinh">Thực hiện</button>
          			</div>
          		</div>
          	</div>
          </div>
