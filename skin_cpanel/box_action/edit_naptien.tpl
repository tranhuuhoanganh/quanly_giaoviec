    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Sửa giao dịch nạp tiền</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control price_format" name="sotien" value="{sotien}" placeholder="Nhập số tiền cần nạp...">
                </div>
                <div class="form_group">
            ...
            <div class="form_group">
                ...
                <button name="edit_naptien" class="button_all"> Lưu thay đổi</button>
            </div>
        </div>
    </div>
</div>
