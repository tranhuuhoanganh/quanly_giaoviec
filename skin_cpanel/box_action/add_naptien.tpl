    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 465px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Tặng, hoàn tiền</span></div>
          <div class="box_form">
          	<div class="list_tab_content">
          		<div class="li_tab_content active" id="tab_hangnhap_content">
          			<div class="li_input">
          				<label>Tài khoản(*)</label>
          				<input type="text" name="username" placeholder="Nhập tài khoản nhận tiền" autocomplete="off">
          			</div>
                <div class="li_input">
                  <label>Số tiền(*)</label>
                  <input type="text" name="sotien" class="price_format" placeholder="Nhập số tiền cần nạp" autocomplete="off">
                </div>
                <div class="li_input">
                  <label>Loại tiền(*)</label>
                  <select name="loai">
                    <option value="1">Tài khoản chính</option>
                    <option value="0">Tài khoản khuyến mại</option>
                  </select>
                </div>
                <div class="li_input">
                  ...
                  <textarea name="noidung" placeholder="Nhập nội dung"></textarea>
          			...
          			<div class="list_button">
          				<button name="add_naptien">Thực hiện</button>
          			</div>
          		</div>
          	</div>
          </div>
