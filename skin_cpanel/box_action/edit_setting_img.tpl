                    ...
                    <div class="list_tab_content">
                        <div class="li_tab_content active" id="tab_hangnhap_content">
                            ...
                            <div class="li_input">
                                <div class="khung_mh">
                                    <div class="mh" style="cursor: pointer;">
                                        <img src="{value}" onerror="this.src='/images/no-images.jpg';" width="200" id="preview-minhhoa" title="click để chọn ảnh">
                                    </div>
                            ...
                            <div class="list_button">
                                ...
                                <button name="edit_setting_img">Lưu thay đổi</button>
                            </div>
                        </div>
                    </div>
                </div>
