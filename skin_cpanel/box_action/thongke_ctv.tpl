  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 800px;padding: 10px;">
        <div class="box_result">
            <div class="li_box">
                <h3 class="color_violet">CTV đăng ký hôm qua({homqua})</h3>
            ...
            <div class="li_box">
                <h3 class="color_orange">CTV có đơn hôm qua({homqua})</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_huy">{total_co_don_homqua} thành viên({total_don_homqua} đơn hàng)</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
            ...
            <div class="li_box">
                <h3 class="color_green">CTV đăng ký hôm nay(<?php echo date('d/m/Y');?>)</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
            ...
            <div class="li_box">
                <h3 class="color_red">CTV có đơn hôm nay(<?php echo date('d/m/Y');?>)</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_huy">{total_co_don} thành viên({total_don} đơn hàng)</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
        ...
        <div class="box_time">
            ...
            <div class="list_time">
                ...
                <div class="li_time">
                    <button name="button_thongke_ctv">Áp dụng</button>
                </div>
            </div>
        </div>
        <div class="box_result">
