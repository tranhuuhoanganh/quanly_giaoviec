    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Danh sách quản trị viên</span></div>
          <div class="list_hang" style="max-height: none;">
            <table class="table_hang" style="width: 100%;" max-width="1000">
              <tr>
                ...
                <th class="sticky-row" width="150">Bộ phận</th>
                <th class="sticky-row sticky-column" width="180" max-width="170">Hành động</th>
              </tr>
              {list_quantri}
            </table>
          </div>
