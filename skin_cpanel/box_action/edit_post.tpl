    ...
    <div class="box_right_content">
        <div class="box_profile" style="width: 960px;">
            <div class="page_title">
                <h1 class="undefined">Chỉnh sửa bài viết</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control tieude_seo" name="tieu_de" onkeyup="check_blank('baiviet');" value="{tieu_de}" placeholder="Nhập tiêu đề...">
                </div>
                <div class="form_group">
                    <label for="">Link xem</label>
                    <input type="text" class="form_control link_seo" name="link" onkeyup="check_link('baiviet');" value="{link}" placeholder="Nhập link xem...">
            ...
            <div class="form_group">
                ...
                <button class="button_all" name="edit_post"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
