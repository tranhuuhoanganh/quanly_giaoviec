    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_search">
            <div class="li_input">
                <input type="text" name="key" placeholder="Nhập tên, số điện thoại...">
            </div>
            <button id="timkiem_thanhvien">Tìm kiếm</button>
        </div>
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Danh sách thành viên</span><button class="hide_mobile" onclick="show_add('thanhvien','');"><i class="fa fa-plus"></i> Thêm thành viên</button></div>
          <div class="list_hang" style="max-height: none;">
            <table class="table_hang" style="width: 100%;" max-width="1000">
              <tr>
                ...
                <th class="sticky-row" width="150">Booking đã tạo</th>
                <th class="sticky-row" width="150">Booking đã đặt</th>
                <th class="sticky-row" width="100">Số dư</th>
                <th class="sticky-row" width="100">KM</th>
                <th class="sticky-row" width="100">Active</th>
                <th class="sticky-row" width="150">CSKH</th>
                <th class="sticky-row sticky-column" width="150" max-width="100">Hành động</th>
              </tr>
              {list_thanhvien}
            </table>
          </div>
