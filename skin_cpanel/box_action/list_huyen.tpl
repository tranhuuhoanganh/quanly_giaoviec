    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 650px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> <b>{ten_tinh}</b></span><button onclick="show_add('huyen','{tinh}');"><i class="fa fa-plus"></i> Thêm huyện</button></div>
          <div class="list_hang" style="max-height: none;">
            <table class="table_hang" style="width: 100%;">
              <tr>
                <th class="sticky-row" width="40">STT</th>
                <th class="sticky-row">Quận/Huyện</th>
                <th class="sticky-row sticky-column" width="360" max-width="140">Hành động</th>
              </tr>
              {list_huyen}
            </table>
          </div>
