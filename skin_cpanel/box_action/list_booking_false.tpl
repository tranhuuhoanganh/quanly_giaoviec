    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_search">
            ...
            <button id="timkiem_booking_false">Tìm kiếm</button>
        </div>
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Booking đã từ chối</span></div>
          <div class="list_hang" style="max-height: none;" tiep='1' page='1' loaded="1">
            <table class="table_hang" style="width: 1600px;">
              <tr>
                ...
                <th class="sticky-row" width="120">Hãng tàu</th>
