...
<div class="box_right">
    <div class="box_right_content">
        <div class="box_container">
            <div class="box_container_left" style="width: 1000px;margin: auto;">
                <div class="title"><span class="text"><i class="fa fa-th"></i> Chỉnh sửa bài viết</span></div>
                <div class="box_form">
                    <div class="list_tab_content">
                        <div class="li_tab_content active" id="tab_hangnhap_content">
                            <div class="li_input">
                                <div class="khung_mh">
                                    <div class="mh" style="cursor: pointer;">
                                        <img src="{minh_hoa}" onerror="this.src='/images/no-images.jpg';" width="200" id="preview-minhhoa" title="click để chọn ảnh minh họa">
                                    </div>
                                    <button id="chon_anh">Chọn ảnh minh họa</button>
                                    <input type="file" name="minh_hoa" id="minh_hoa" style="display: none;">
                                </div>
                            </div>
                            <div class="li_input">
                                <label>Tiêu đề(*)</label>
                                <input type="text" name="tieu_de" value="{tieu_de}" autocomplete="off">
                            </div>
                            <div class="li_input">
                            ...
                            <div class="li_input">
                                ...
                                <textarea name="value" id="edit_textarea">{noi_dung}</textarea>
                                <input type='file' name='fileupload' id='fileupload' style='display: none;'>
                            </div>
                            <div class="list_button">
                                <input type="hidden" name="id" value="{id}">
                                <button name="edit_baiviet">Lưu thay đổi</button>
                            </div>
                        </div>
                    </div>
                </div>
