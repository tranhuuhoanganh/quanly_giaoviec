<div class="box_right">
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 600px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Danh sách tỉnh</span><button onclick="show_add('tinh','');"><i class="fa fa-plus"></i> Thêm tỉnh mới</button></div>
          <div class="list_hang" style="max-height: none;">
            <table class="table_hang" style="width: 100%;">
              <tr>
                ...
                <th class="sticky-row sticky-column" width="300" max-width="140">Hành động</th>
              </tr>
              {list_tinh}
            </table>
          </div>
