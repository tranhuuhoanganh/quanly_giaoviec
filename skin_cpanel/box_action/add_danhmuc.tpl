    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 465px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Thêm danh mục bài viết</span></div>
          <div class="box_form">
          	<div class="list_tab_content">
          		<div class="li_tab_content active" id="tab_hangnhap_content">
                <div class="li_input">
                  <label>Tên danh mục(*)</label>
                  <input type="text" name="tieu_de" placeholder="Nhập tên danh mục" autocomplete="off">
                </div>
          			<div class="list_button">
          				<button name="add_danhmuc">Hoàn thành</button>
          			</div>
          		</div>
          	</div>
          </div>
