    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_search">
            ...
            <button id="timkiem_booking_wait">Tìm kiếm</button>
        </div>
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Booking chờ xác nhận</span></div>
          <div class="list_hang" style="max-height: none;" tiep='1' page='1' loaded="1">
            <table class="table_hang" style="width: 1600px;">
              <tr>
                <th class="sticky-row" width="80">STT</th>
                <th class="sticky-row" width="120">Số booking</th>
                <th class="sticky-row" width="100">Hãng tàu</th>
                <th class="sticky-row" width="100">Loại container</th>
                <th class="sticky-row" width="120">Mặt hàng</th>
                <th class="sticky-row">Số hiệu</th>
                <th class="sticky-row">Cước vận chuyển</th>
                <th class="sticky-row">Cước nhận chuyển</th>
                <th class="sticky-row" width="150">Thời gian trả hàng</th>
                <th class="sticky-row" width="180">Thời gian nhận trả hàng</th>
                <th class="sticky-row sticky-column" width="100" max-width="100">Hành động</th>
              </tr>
              {list_booking}
            </table>
          </div>
