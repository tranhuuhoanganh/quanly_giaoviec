  ...
  <div class="box_right_content">
  	<div class="box_profile" style="width: 800px;padding: 10px;">
        <div class="box_result">
            <div class="li_box">
                <h3 class="color_green">Giao dịch hôm nay({homnay})</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_hoanthanh">{total_homnay}đ({total_giaodich_homnay} giao dịch)</div>
                    </div>
            ...
            <div class="li_box">
                <h3 class="color_violet">Giao dịch hôm qua({homqua})</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_huy">{total_homqua}đ({total_giaodich_homqua} giao dịch)</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
        ...
        <div class="box_time">
            <h2>Thống kê giao dịch mua web</h2>
            <div class="list_time">
                <div class="li_time">
                ...
                <div class="li_time">
                    <button name="button_thongke_muaweb">Áp dụng</button>
                </div>
            </div>
        </div>
        <div class="box_result">
            <div class="li_box" style="width: 100%;">
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu color_red" id="doanhthu_tk">{total_tk}đ({total_giaodich_tk} giao dịch)</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
