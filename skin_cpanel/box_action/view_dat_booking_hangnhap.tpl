    ...
    <div class="box_right_content">
        <div class="box_container">
            <div class="box_container_left" style="width: 100%;">
                <div class="title"><span class="text"><i class="fa fa-th"></i> Thông tin giao dịch</span></div>
                <div class="box_form">
                    <div class="list_tab_content">
                        <div class="li_tab_content active" id="tab_hangnhap_content">
                        	<div class="list_box_giaodich">
	                        	<div class="box_nguoidang">
	                        		<div class="title_box">Thông tin người đặt</div>
		                            <div class="li_input">
		                                <label>Công ty</label>
		                                {cong_ty_dat}
		                            </div>
	                        	...
	                        	<div class="box_nguoidang">
	                        		<div class="title_box">Thông tin người đăng</div>
		                            <div class="li_input">
		                                <label>Công ty</label>
		                                {cong_ty}
		                            </div>
            ...
            <div class="box_container_left" style="width: 100%;">
                <div class="title"><span class="text"><i class="fa fa-th"></i> Chi tiết đặt booking</span></div>
                <div class="box_form">
                    <div class="list_tab_content">
                        <div class="li_tab_content active" id="tab_hangxuat_content" style="overflow: auto;">
                            <table class="bang_info" max-width="1000">
                                <tr>
                                ...
                                <tr>
                                    <td class="text">Số hiệu container</td>
                                    <td class="info">{so_hieu}</td>
                                </tr>
                                <tr>
                                    <td class="text">Địa chỉ đóng hàng(cảng)</td>
                                    <td class="info">
                                      {diachi_donghang}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text">Địa chỉ trả hàng</td>
                                    <td class="info">
                                        <table>
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="info">{thoi_gian_booking} {ngay_booking}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="info color_red"><b>{gia_booking} đ</b></td>
                                </tr>
                                <tr>
                            ...
                            <table class="bang_info" style="margin-top: 10px;" max-width="1000">
                                <tr>
                                    <td width="180" class="text">Giá cước nhận</td>
                                    <td class="info">{gia} đ</td>
                                </tr>
                                <tr>
                                    <td class="text">Thời gian nhận trả hàng</td>
                                    <td class="info">{thoi_gian} {ngay}</td>
                                </tr>
                                <tr>
                                    <td class="text">Số liên hệ</td>
                                    <td class="info">{lien_he}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="text">Đặt lúc</td>
                                    <td class="info">{date_post}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
