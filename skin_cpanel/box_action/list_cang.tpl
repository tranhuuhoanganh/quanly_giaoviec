    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Danh sách cảng</span><button onclick="show_add('cang','');"><i class="fa fa-plus"></i> Thêm cảng</button></div>
