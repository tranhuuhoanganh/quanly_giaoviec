    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 100%;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Danh sách loại container</span><button onclick="show_add('container','');"><i class="fa fa-plus"></i> Thêm mới</button></div>
