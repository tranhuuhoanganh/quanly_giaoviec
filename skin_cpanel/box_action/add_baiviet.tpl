    ...
    <div class="box_right_content">
        <div class="box_container">
            <div class="box_container_left" style="width: 1000px;margin: auto;">
                <div class="title"><span class="text"><i class="fa fa-th"></i> Thêm bài viết mới</span></div>
                <div class="box_form">
                    <div class="list_tab_content">
                        <div class="li_tab_content active" id="tab_hangnhap_content">
                            ...
                            <div class="li_input">
                                <label>Tiêu đề(*)</label>
                                <input type="text" name="tieu_de" value="" autocomplete="off">
                            </div>
                            <div class="li_input">
                            ...
                            <div class="li_input">
                                ...
                                <textarea name="value" id="edit_textarea"></textarea>
                                <input type='file' name='fileupload' id='fileupload' style='display: none;'>
                            </div>
                            <div class="list_button">
                                <input type="hidden" name="id" value="{name}">
                                <button name="add_baiviet">Lưu thay đổi</button>
                            </div>
                        </div>
                    </div>
                </div>
