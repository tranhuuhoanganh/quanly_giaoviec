        ...
        <div class="box_time">
            ...
            <div class="list_time">
                ...
                <div class="li_time">
                    ...
                    <button name="button_doanhso_naptien_cskh">Áp dụng</button>
                </div>
            </div>
        </div>
        <div class="box_result">
            <div class="li_box">
                <h3 class="color_green">Giao dịch hoàn thành</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_hoanthanh">{doanhthu_hoanthanh} đ</div>
                        <div class="text_donhang" id="giaodich_hoanthanh"> với {giaodich_hoanthanh} giao dịch</div>
                    </div>
            ...
            <div class="li_box">
                <h3 class="color_brown">Giao dịch chờ xử lý</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_cho">{doanhthu_cho} đ</div>
                        <div class="text_donhang" id="giaodich_cho"> với {giaodich_cho} giao dịch</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
            ...
            <div class="li_box">
                <h3 class="color_orange">Giao dịch chờ xác nhận</h3>
                <div class="li_box_content">
                    <div class="li_box_left">
                        <div class="text_doanhthu" id="doanhthu_cho_xacnhan">{doanhthu_cho_xacnhan} đ</div>
                        <div class="text_donhang" id="giaodich_cho_xacnhan"> với {giaodich_cho_xacnhan} đơn hàng</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
            ...
            <div class="li_box">
                ...
                <div class="li_box_content">
                    <div class="li_box_left">
                        ...
                        <div class="text_donhang" id="giaodich_huy"> với {giaodich_huy} đơn hàng</div>
                    </div>
                    <div class="li_box_right">
                        <div class="li_box_right_content">
