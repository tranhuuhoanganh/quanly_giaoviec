    ...
    <div class="box_right_content">
      <div class="box_container">
        <div class="box_container_left" style="width: 465px;margin: auto;">
          <div class="title"><span class="text"><i class="fa fa-th"></i> Thêm gói gia hạn</span></div>
          <div class="box_form">
          	<div class="list_tab_content">
          		<div class="li_tab_content active" id="tab_hangnhap_content">
                <div class="li_input">
                  <label>Tên gói(*)</label>
                  <input type="text" name="tieu_de" placeholder="Nhập tên gói gia hạn" autocomplete="off">
                </div>
                <div class="li_input">
                  <label>Phí gia hạn(*)</label>
                  <input type="text" name="so_tien" class="price_format" placeholder="Nhập phí gia hạn" autocomplete="off">
                </div>
          			<div class="li_input">
          				<label>Số ngày(*)</label>
          				<input type="text" name="thoi_gian" placeholder="Nhập số ngày gia hạn" autocomplete="off">
          			</div>
                <div class="li_input">
                  <label>Thứ tự(*)</label>
                  <input type="text" name="thu_tu" placeholder="Nhập thứ tự sắp xếp" autocomplete="off">
                </div>
                <div class="li_input">
                  ...
                  <div class="list_checkbox">
                    ...
                    <div class="li_checkbox">
          			...
          			<div class="list_button">
          				<button name="add_goi_giahan">Hoàn thành</button>
          			</div>
          		</div>
          	</div>
          </div>
