<div class="box_right">
  <div class="box_right_content">
  	<div class="box_profile" style="width: 100%;padding: 10px;">
  		<h1>Giao dịch nạp tiền năm {nam}</h1>
        <div class="chart">
            <!-- Chart wrapper -->
        ...
        <h1>Trạng thái giao dịch {nam}</h1>
        <div class="chart">
            <figure class="highcharts-figure">
        ...
        <h1>Nạp tiền tháng {thang}/{nam}</h1>
        <div class="chart">
            <!-- Chart wrapper -->
            <figure class="highcharts-figure">
        ...
        <h1>Trạng thái nạp tiền tháng {thang}/{nam}</h1>
        <div class="chart">
            <figure class="highcharts-figure">
