  		...
  		<div class="box_yeucau_hotro">
		    <div class="box_yeucau">
		        <div class="box_search">
		        	<button id="show_add_hotro">Tạo yêu cầu hỗ trợ</button>
		        </div>
		        <div class="list_yeucau">
		            <div class="list_yeucau_title"><div class="name">Phiên yêu cầu</div><div class="note">Chủ đề</div></div>
		            <div class="list" id="list_yeucau">
		            	{list_yeucau}
		            </div>
		        </div>
		    </div>
