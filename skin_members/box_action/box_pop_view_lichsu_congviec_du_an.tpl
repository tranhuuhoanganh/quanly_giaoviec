<div class="box_pop_view_lichsu_congviec_du_an">
    <div class="box_pop_view_lichsu_congviec_du_an_dialog">
        <div class="box_pop_view_lichsu_congviec_du_an_content">

            <div class="box_pop_view_lichsu_congviec_du_an_header">
                <div class="box_pop_view_lichsu_congviec_du_an_title_wrapper">
                    <h5 class="box_pop_view_lichsu_congviec_du_an_title">Chi tiết công việc dự án</h5>
                </div>
                <button type="button" class="box_pop_view_lichsu_congviec_du_an_close" aria-label="Đóng">
                    <i class="fa fa-times"></i>
                </button>
            </div>

            <div class="box_pop_view_lichsu_congviec_du_an_body">
                <div class="box_pop_view_lichsu_congviec_du_an_content_wrapper">

                    <!-- Thông tin công việc -->
                    <div class="box_pop_view_lichsu_congviec_du_an_main">
                        <div class="box_pop_view_lichsu_congviec_du_an_section">
                ...
                <!-- Action Buttons -->
                <div class="box_pop_view_lichsu_congviec_du_an_footer">
                    <div class="box_pop_view_lichsu_congviec_du_an_actions">
                        <div class="box_pop_view_lichsu_congviec_du_an_actions_left">
...
<style>
    ...
    .box_pop_view_lichsu_congviec_du_an,
    .box_pop_view_lichsu_congviec_du_an * {
    ...
    /* Dialog container */
    .box_pop_view_lichsu_congviec_du_an_dialog {
        width: 100%;
        max-width: 1200px;
    ...
    /* Content card */
    .box_pop_view_lichsu_congviec_du_an_content {
        background: #ffffff;
        border-radius: 8px;
        overflow: hidden;
    ...
    /* Header */
    .box_pop_view_lichsu_congviec_du_an_header {
        display: flex;
        align-items: center;
    ...
    .box_pop_view_lichsu_congviec_du_an_title_wrapper {
        display: flex;
        align-items: center;
        gap: 10px;
    }

    .box_pop_view_lichsu_congviec_du_an_title {
        margin: 0;
        font-size: 18px;
        font-weight: 600;
        color: #111827;
    ...
    .box_pop_view_lichsu_congviec_du_an_close {
        width: 32px;
        height: 32px;
        background: #f3f4f6;
        border: none;
    ...
    .box_pop_view_lichsu_congviec_du_an_close i {
        font-size: 16px;
        font-family: "FontAwesome" !important;
    }

    .box_pop_view_lichsu_congviec_du_an_close:hover {
        background: #e5e7eb;
        color: #374151;
        transform: scale(1.05);
    }

    .box_pop_view_lichsu_congviec_du_an_close:active {
        transform: scale(0.95);
    }

    /* Body */
    .box_pop_view_lichsu_congviec_du_an_body {
        flex: 1;
        overflow-y: auto;
        padding: 24px;
    }
    ...
    /* Content wrapper */
    .box_pop_view_lichsu_congviec_du_an_content_wrapper {
        display: flex;
        flex-direction: column;
        gap: 24px;
        width: 100%;
    ...
    /* Main content */
    .box_pop_view_lichsu_congviec_du_an_main {
        display: flex;
        flex-direction: column;
        gap: 20px;
    }
    ...
    /* Section */
    .box_pop_view_lichsu_congviec_du_an_section {
        background: #ffffff;
        border: none;
        border-radius: 0;
        padding: 0;
    ...
    .box_pop_view_lichsu_congviec_du_an_section:last-child {
        border-bottom: none;
        padding-bottom: 0;
    }
    ...
    /* Footer Actions */
    .box_pop_view_lichsu_congviec_du_an_footer {
    ...
    .box_pop_view_lichsu_congviec_du_an_actions {
        display: flex;
        gap: 12px;
    ...
    .box_pop_view_lichsu_congviec_du_an_actions_left {
        display: flex;
        gap: 12px;
        align-items: center;
    }

    .box_pop_view_lichsu_congviec_du_an_actions .btn {
        display: inline-flex;
        align-items: center;
        gap: 6px;
        padding: 10px 20px;
    ...
    .box_pop_view_lichsu_congviec_du_an_actions .btn.btn-primary {
        background: #0062A0;
        color: #ffffff;
    }

    .box_pop_view_lichsu_congviec_du_an_actions .btn.btn-primary:hover:not(:disabled) {
        background: #005085;
        transform: translateY(-1px);
        box-shadow: 0 4px 8px rgba(0, 98, 160, 0.3);
    }

    .box_pop_view_lichsu_congviec_du_an_actions .btn.btn-secondary {
        background: #f8f9fa;
        color: #373b3f;
        border: 1.5px solid #dee2e6;
    }

    .box_pop_view_lichsu_congviec_du_an_actions .btn.btn-secondary:hover:not(:disabled) {
        background: #e9ecef;
        border-color: #adb5bd;
        transform: translateY(-1px);
    ...
    .box_pop_view_lichsu_congviec_du_an_actions .btn:active:not(:disabled) {
        transform: translateY(0);
    }
...
<script>
    // Close button
    $(document).on('click', '.box_pop_view_lichsu_congviec_du_an_close', function () {
        $('.box_pop_view_lichsu_congviec_du_an').hide();
        $('.box_pop_view_lichsu_congviec_du_an').html('');
    });

    // Click outside to close
    $(document).on('click', '.box_pop_view_lichsu_congviec_du_an', function (e) {
        if ($(e.target).hasClass('box_pop_view_lichsu_congviec_du_an')) {
            $('.box_pop_view_lichsu_congviec_du_an').hide();
            $('.box_pop_view_lichsu_congviec_du_an').html('');
        }
    });
