<tr id="{id}">
    ...
    <td>
        <div class="project_name">{ten_du_an}</div>
    </td>
    <td>
        <div class="creator_info">
            <div class="creator_name">{ten_nguoi_tao}</div>
    ...
    <td class="text-center">{ngay_tao}</td>
    <td class="text-center" id="status_trang_thai_item" >
        <div style="display: block; text-align: center;">
            <div>{trang_thai_text}</div>
        <div>{miss_deadline_text}</div>
        </div>
    </td>
    <td class="text-center sticky-column">
        <div class="action_buttons">
            <button class="btn_action btn_view" name="view_du_an" data-id="{id}" title="Xem">
                <i class="fa fa-eye"></i>
            </button>
        </div>
    </td>
