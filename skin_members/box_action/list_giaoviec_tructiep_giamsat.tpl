        ...
        <div class="box_container">
            <div class="box_container_left" style="width: 100%;">
                ...
                <div class="list_header">
                    <div class="header_title_giamsat">
                ...
                <div class="list_filter">
                    ...
                    <div class="filter_content">
                        <div class="filter_group">
                            ...
                            <input type="text" name="search_keyword" class="filter_input" placeholder="Tìm kiếm theo tên công việc...">
                        </div>
                        <div class="filter_group">
                        ...
                        <div class="filter_group filter_group_date">
                            <label class="filter_label">Ngày bắt đầu</label>
                            <input type="date" name="filter_ngay_bat_dau" class="filter_input filter_date">
                        </div>

                        <div class="filter_group filter_group_date">
                            <label class="filter_label">Hạn hoàn thành</label>
                            <input type="date" name="filter_han_hoan_thanh" class="filter_input filter_date">
                        </div>
                ...
                <!-- List -->
                <div class="list_giaoviec_wrapper">
                    <table class="table_giaoviec_giamsat" style="width: 100%;">
                        <thead>
                            <tr>
                ...
                <!-- Phân trang -->
                    ...
                    <div class="list_phantrang" id="{id_phantrang}">
                        {phantrang}
                    </div>
                ...
                <div class="empty_state" id="empty_state" style="display: none;">
                    ...
                    <div class="empty_text">
                        ...
                        <a href="/members/add-giaoviec-tructiep" class="btn_add_empty">
                            <i class="fa fa-plus"></i> Thêm công việc mới
                        </a>
                    </div>
                </div>
            </div>
...
.table_giaoviec_giamsat {
    width: 100%;
    border-collapse: collapse;
    background: #fff;
}

.table_giaoviec_giamsat thead {
    background: #f8f9fa;
}

.table_giaoviec_giamsat th {
    padding: 14px 16px;
    text-align: left;
    font-weight: 600;
    font-size: 13px;
...
.table_giaoviec_giamsat th.text-center {
    text-align: center;
}

.table_giaoviec_giamsat td {
    padding: 14px 16px;
...
.table_giaoviec_giamsat tbody tr {
    transition: background-color 0.15s ease;
}

.table_giaoviec_giamsat tbody tr:hover {
    background: #f8f9fa;
}

.table_giaoviec_giamsat tbody tr:last-child td {
    border-bottom: none;
}
...
.table_giaoviec_giamsat tbody tr:hover .sticky-column {
    background: #f8f9fa;
}
...
.giaoviec_item.priority_cao {
    border-left-color: #e53e3e;
}

.giaoviec_item.priority_rat_cao {
    border-left-color: #c53030;
}

.giaoviec_item.priority_binh_thuong {
    border-left-color: #0062a0;
}

.giaoviec_item.priority_thap {
...
<style>
    ...
    /* Tạo overlay click trên toàn bộ group */
    .filter_group_date::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
    ...
    $(document).ready(function() {
        $('.filter_group_date').on('click', function(e) {
