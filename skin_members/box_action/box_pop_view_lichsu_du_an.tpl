<div class="box_pop_view_lichsu_du_an">
    <div class="box_pop_view_lichsu_du_an_dialog">
      <div class="box_pop_view_lichsu_du_an_content">
  
        <div class="box_pop_view_lichsu_du_an_header">
          <div class="box_pop_view_lichsu_du_an_title_wrapper">
            <h5 class="box_pop_view_lichsu_du_an_title">Chi tiết lịch sử dự án</h5>
          </div>
          <button type="button" class="box_pop_view_lichsu_du_an_close" aria-label="Đóng">
            <i class="fa fa-times"></i>
          </button>
        </div>
  
        <div class="box_pop_view_lichsu_du_an_body">
          <div class="box_pop_view_lichsu_du_an_content_wrapper">
            
            <!-- Phần trên: Thông tin dự án và Sidebar -->
            <div class="box_pop_view_lichsu_du_an_top_section">
              <!-- Cột trái: Thông tin dự án -->
              <div class="box_pop_view_lichsu_du_an_main">
                <div class="box_pop_view_lichsu_du_an_section">
                  ...
                  <div class="section_fields">
                    ...
                    <div class="field field_half">
                      <label class="field_label">Ngày hoàn thành:</label>
                      <div class="field_value">{ngay_hoanthanh}</div>
                    </div>
              ...
              <!-- Cột phải: Sidebar -->
              <div class="box_pop_view_lichsu_du_an_sidebar">
                <div class="box_pop_view_lichsu_du_an_section">
                  <div class="section_header">
            ...
            <div class="box_pop_view_lichsu_du_an_section box_pop_view_lichsu_du_an_section_fullwidth" id="sodo_phan_cong">
  ...
  <div class="box_pop_view_lichsu_congviec_du_an" style="display: none;"></div>
  <style>
    /* Reset và base styles */
    .box_pop_view_lichsu_du_an,
    .box_pop_view_lichsu_du_an * {
    ...
    /* Dialog container */
    .box_pop_view_lichsu_du_an_dialog {
      width: 100%;
      max-width: 1400px;
    ...
    /* Content card */
    .box_pop_view_lichsu_du_an_content {
      background: #ffffff;
      border-radius: 8px;
      overflow: hidden;
    ...
    /* Header */
    .box_pop_view_lichsu_du_an_header {
      display: flex;
      align-items: center;
    ...
    .box_pop_view_lichsu_du_an_title_wrapper {
      display: flex;
      align-items: center;
      gap: 10px;
    }
  
    .box_pop_view_lichsu_du_an_title {
      margin: 0;
      font-size: 18px;
      font-weight: 600;
      color: #111827;
    ...
    .box_pop_view_lichsu_du_an_close {
      width: 32px;
      height: 32px;
      background: #f3f4f6;
      border: none;
    ...
    .box_pop_view_lichsu_du_an_close i {
      font-size: 16px;
      font-family: "FontAwesome" !important;
    }
  
    .box_pop_view_lichsu_du_an_close:hover {
      background: #e5e7eb;
      color: #374151;
      transform: scale(1.05);
    }
  
    .box_pop_view_lichsu_du_an_close:active {
      transform: scale(0.95);
    }
  
    /* Body */
    .box_pop_view_lichsu_du_an_body {
      flex: 1;
      overflow-y: auto;
      padding: 24px;
    }
    ...
    /* Content wrapper */
    .box_pop_view_lichsu_du_an_content_wrapper {
      display: flex;
      flex-direction: column;
      gap: 24px;
      width: 100%;
    ...
    .box_pop_view_lichsu_du_an_top_section {
      display: grid;
    ...
    .box_pop_view_lichsu_du_an_main,
    .box_pop_view_lichsu_du_an_sidebar {
      display: flex;
      flex-direction: column;
    }
  
    /* Section full width cho sơ đồ */
    .box_pop_view_lichsu_du_an_section_fullwidth {
      width: 100%;
      margin-bottom: 0;
    }
  
    /* Section */
    .box_pop_view_lichsu_du_an_section {
      background: #ffffff;
    ...
    .box_pop_view_lichsu_du_an_sidebar .box_pop_view_lichsu_du_an_section {
      flex: 1;
      height: 100%;
    }
  ...
  <script>
    // Close button
    $(document).on('click', '.box_pop_view_lichsu_du_an_close', function() {
      $('.box_pop_add').hide();
      $('.box_pop_add').html('');
    });
  
    // Click outside to close
    $(document).on('click', '.box_pop_view_lichsu_du_an', function(e) {
      if ($(e.target).hasClass('box_pop_view_lichsu_du_an')) {
        $('.box_pop_add').hide();
        $('.box_pop_add').html('');
      }
    });
    ...
    function initOrgChart() {
      ...
      $('#orgchart-container').orgchart({
        ...
        'createNode': function($node, data) {
          ...
          $node.addClass('box_lichsu_congviec_du_an');
          // Thêm data-id vào node để có thể lấy id khi click
          if (data.id) {
