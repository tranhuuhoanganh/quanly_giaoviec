        ...
        <div class="box_container">
            <div class="box_container_left" style="width: 100%;">
                ...
                <div class="list_giaoviec_wrapper">
                    <table class="table_giaoviec_nhan" style="width: 100%;">
                        <thead>
                            <tr>
...
.table_giaoviec_nhan thead {
    background: #f8f9fa;
}

.table_giaoviec_nhan th {
    padding: 14px 16px;
    text-align: left;
    font-weight: 600;
    font-size: 13px;
...
.table_giaoviec_nhan th.text-center {
    text-align: center;
}

.table_giaoviec_nhan td {
    padding: 14px 16px;
...
.table_giaoviec_nhan tbody tr {
    transition: background-color 0.15s ease;
}

.table_giaoviec_nhan tbody tr:hover {
    background: #f8f9fa;
}

.table_giaoviec_nhan tbody tr:last-child td {
    border-bottom: none;
}
...
.table_giaoviec_nhan tbody tr:hover .sticky-column {
    background: #f8f9fa;
}
