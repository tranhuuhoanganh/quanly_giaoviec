<tr id="{id}">
    ...
    <td>
        <div class="creator_info">
            ...
            <div class="creator_role">{ten_phongban}</div>
        </div>
    </td>
    ...
    <td class="text-center">
        <div class="deadline_display">
            <div class="deadline_date han_hoan_thanh_value">{han_hoan_thanh}</div>
            <div class="deadline_countdown" data-deadline="{deadline_timestamp}" data-id="{id}" data-type="giaoviec_tructiep"></div>
        </div>
    </td>
    <td class="text-center status_trang_thai_item" >
        {trang_thai_text}
    </td>
    <td class="text-center">
        <div class="action_buttons">
            <button class="btn_action btn_view" name="view_giaoviec" title="Xem" data-id="{id}">
                <i class="fa fa-eye"></i>
            </button>
            <button class="btn_action btn_edit" name="box_pop_edit_giaoviec_tructiep" title="Sửa">
                <i class="fa fa-pencil"></i>
            </button>
            <button class="btn_action btn_delete" name="box_pop_delete_giaoviec_tructiep" data title="Xóa">
