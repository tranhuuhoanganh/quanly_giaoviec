    ...
    <div class="box_right_content">
        <div class="box_container">
            <div class="box_container_left" style="width: 100%;">
                ...
                <div class="list_filter">
                    ...
                    <div class="filter_content">
                        <div class="filter_group">
                            ...
                            <input type="text" name="search_keyword" class="filter_input"
                ...
                <!-- List -->
                <div class="list_giaoviec_giao_wrapper">
                    <table class="table_giaoviec" style="width: 100%;">
                        <thead>
                            <tr>
...
<style>
    ...
    .table_giaoviec tbody tr {
        transition: background-color 0.15s ease;
    }

    .table_giaoviec tbody tr:hover {
        background: #f8f9fa;
    }

    .table_giaoviec tbody tr:last-child td {
        border-bottom: none;
    }
    ...
    .table_giaoviec tbody tr:hover .sticky-column {
        background: #f8f9fa;
    }
