<tr id="tr_lichsu_giaoviec_{id}" class="tr_lichsu_giaoviec_row">
    ...
    <td class="text-center action_cell">
        <div class="action_buttons">
            <button class="btn_action btn_view" name="box_pop_view_lichsu_giaoviec" data-id="{id}" title="Xem chi tiết">
                <i class="fa fa-eye"></i>
            </button>
        </div>
    </td>
...
<style>
.tr_lichsu_giaoviec_row {
    transition: background-color 0.2s ease;
}

.tr_lichsu_giaoviec_row:hover {
    background-color: #f8f9fa;
}

.tr_lichsu_giaoviec_row td {
    padding: 16px 12px;
