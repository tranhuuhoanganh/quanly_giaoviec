    ...
    <div class="menu_top">
      <div class="menu_top_left">
        ...
        <div class="title_action">
          <span><i class="fa fa-th"></i> {title_action}</span>
        </div>
      </div>
      <div class="menu_top_right">
        ...
        <div class="drop_down">
          ...
          <div class="drop_menu" style="width: 200px;">
            ...
            <div class="line"></div>
            <a class="drop_item" href="/members/profile"><i class="icon icon-profile"></i> Profile</a>
            <div class="line"></div>
            <a class="drop_item text_danger" href="/members/logout"><i class="mr-3 icon icon-switch"></i> Đăng xuất</a>
          </div>
        </div>
