...
<body>
    <div class="container">
        <h1>Thông Báo Booking Được Đặt</h1>
        <p>Kính gửi <b>{ho_ten}</b>,</p>
        <p>Chúng tôi xin thông báo rằng một booking của bạn vừa được đặt trên sàn giao dịch vận tải <a href="http://ketnoivanchuyen.vn">http://ketnoivanchuyen.vn</a> thông tin chi tiết như sau:</p>
        
        <div class="info-section">
            <p>Số booking: {so_booking}</p>
            <p>Số hiệu container: {so_hieu}</p>
            <p>Ngày giờ đóng/trả hàng: {thoi_gian} {ngay}</p>
            <p>Giá cước: {gia} vnđ</p>
        </div>

        <div class="info-section">
            <h2>Thông tin đặt booking:</h2>
